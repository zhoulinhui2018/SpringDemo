...
import xmu.oomall.discount.controller.CartItemController;
...
public class OrderItem implements Cloneable{
    ...
    public OrderItem(OrderItem item){
        ...
        this.setId(item.id);
        this.setGmtCreate(item.gmtCreate);
        this.setProductId(item.productId);
        this.setDealPrice(item.dealPrice);
        this.setBeDeleted(item.beDeleted);
        this.setGmtModified(item.gmtModified);
        this.setItemType(item.itemType);
        this.setOrderId(item.orderId);
        this.setGoodsId(item.goodsId);
        this.setNameWithSpecifications(item.nameWithSpecifications);
        this.setStatusCode(item.statusCode);
    }
